 ...
 * Source:    packages/elements/src/package-info.tsx
...
const changeTypeStyles: Record<ChangeType, string> = {
  added: "bg-info-tint text-info-ink",
  major: "bg-destructive-tint text-destructive-ink",
  minor:
    "bg-warning-tint text-warning-ink",
  patch: "bg-success-tint text-success-ink",
  removed: "bg-muted text-foreground-2",
};
