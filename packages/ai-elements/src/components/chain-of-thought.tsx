 ...
 * Source:    packages/elements/src/chain-of-thought.tsx
  ...
  ({ className, children, ...props }: ChainOfThoughtHeaderProps) => {
    ...
    return (
      <Collapsible onOpenChange={setIsOpen} open={isOpen}>
        <CollapsibleTrigger
          className={cn(
            "flex w-full min-h-[var(--target)] items-center gap-2 text-muted-foreground text-sm transition-colors hover:text-foreground",
            className
          )}
          {...props}
        >
