...
| --------------------------- | ----- | --- |
| `colors_and_type.css`       | ✓ | All brand design tokens — colors, type, spacing, radii, shadow, motion. Symlink to `packages/tokens/src/tokens.css`. |
...
| `guidelines/`               | — | 11 token-enumeration cards generated by guideline-cards.mjs plus 10 hand-authored editorial cards. |
