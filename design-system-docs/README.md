...
| `ui_kits/marketing/`        | ✓ | Marketing UI Kit — Header, Footer, Hero, FeaturedApps, CoachingBand, ServicesBand. |
| `ui_kits/webapp/`           | ✓ | Web App UI Kit — Sidebar, TopBar, StatCard, ProjectsTable. |
| `ui_kits/mobile/`           | ✓ | Mobile UI Kit — PhoneFrame, RecipesScreen, MathsScreen. |
| `ui_kits/docs/`             | ✓ | Docs / Coaching Guide UI Kit. |
| `ui_kits/_shared/`          | ✓ | Shared JSX primitives every kit loads. |
