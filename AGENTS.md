...
- [AI Elements theme](docs/agents/ai-elements-theme.md) — the Miltinson × AI Elements CSS layers, the import chain, and the canvas keyboard path that gates `ai-canvas.css`
