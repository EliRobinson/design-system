const Header = ({ active = 'Home' }) => {
  ...
  return (
    <header style={{
      ...
      <a href="#" style={{ textDecoration: 'none' }}><Wordmark size={22} /></a>
...
const Footer = () => (
  <footer style={{
    ...
    <div style={{
      ...
      gap: 32, paddingBottom: 28, borderBottom: '1px solid oklch(100% 0 0 / 0.18)'
    }}>
      <div>
        ...
        <div style={{
          ...
          color: 'oklch(100% 0 0 / 0.55)', marginTop: 12, textTransform: 'uppercase'
        }}>Builder · Consultant · Founder</div>
      </div>
    ...
    <div style={{
      ...
      color: 'oklch(100% 0 0 / 0.45)', letterSpacing: '0.04em'
    }}>
