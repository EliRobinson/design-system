...
in — see [Installation](/ai-elements/installation), which is three stylesheet imports and one
directive.
...
[the component index](/ai-elements/components) is generated from
...
- [Installation](/ai-elements/installation) — the package, its peers, and the three
  stylesheet imports.
- [Components](/ai-elements/components) — the generated index of every subpath and what it
  exports.
- [Examples](/ai-elements/examples) — a chat round trip, a tool panel that reads, and a
  structured surface.
