...
<p className="lead">
  Heroes invert: an ink block with white type, an amber-accented display line, and at
  most two actions. The dot-grid texture at 8% opacity is the only decoration allowed on
  top.
</p>
